...
const statusFor = (s: string) => STATUS_CONFIG[s?.toLowerCase()] ?? STATUS_CONFIG.pending;
        ...
        <SafeAreaView style={styles.container}>
            ...
            {loading ? (
                <View style={styles.center}>
                    <BasketLoader text="Loading your orders…" />
                </View>
            ) : orders.length === 0 ? (
                <View style={styles.center}>
...
const getStyles = (isDark: boolean) => StyleSheet.create({
    ...
    backBtn: { padding: 8 },
    title: { fontSize: 20, fontWeight: "700", color: isDark ? "#F9FAFB" : "#1F2937" },
    center: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24 },
    emptyTitle: { fontSize: 22, fontWeight: "700", color: isDark ? "#D1D5DB" : "#374151", marginTop: 16, marginBottom: 6 },
    subtitle: { fontSize: 15, color: isDark ? "#9CA3AF" : "#6B7280", marginBottom: 24 },
    shopBtn: { backgroundColor: "#2D6A4F", paddingHorizontal: 28, paddingVertical: 12, borderRadius: 10 },
    ...
    orderId: { fontSize: 16, fontWeight: "700", color: isDark ? "#F9FAFB" : "#111827" },
