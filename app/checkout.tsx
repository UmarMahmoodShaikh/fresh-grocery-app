            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        <Ionicons name="location-outline" size={16} color="#2D6A4F" /> Delivery Address
                    </Text>
                    {addresses.length === 0 ? (
                        <TouchableOpacity
                            ...
                            >
                                <View style={styles.addressCardLeft}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.addressCity}>{addr.city}, {addr.zip_code}</Text>
                                    </View>
                                </View>
                                {addr.is_default && (
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        <Ionicons name="receipt-outline" size={16} color="#2D6A4F" /> Order Summary
                    </Text>
                    {cartItems.map((item) => (
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        <Ionicons name="card-outline" size={16} color="#2D6A4F" /> Payment Method
                    </Text>
                    ...
                    >
                        <View style={styles.payOptionLeft}>
                            <View style={[styles.payIconBg, { backgroundColor: "#D1FAE5" }]}>
                                <Ionicons name="cash-outline" size={22} color="#059669" />
                            </View>
                            <View>
                                <Text style={styles.payOptionTitle}>Cash on Delivery</Text>
                                <Text style={styles.payOptionSub}>Pay when your order arrives</Text>
                            </View>
                        </View>
                    ...
                    >
                        <View style={styles.payOptionLeft}>
                            <View style={[styles.payIconBg, { backgroundColor: "#EDE9FE" }]}>
                    ...
                    {/* PayPal */}
                    <TouchableOpacity
                        style={[styles.payOption, paymentMethod === "paypal" && styles.payOptionSelected]}
                        onPress={() => setPaymentMethod("paypal")}
                    >
                        <View style={styles.payOptionLeft}>
                            <View style={[styles.payIconBg, { backgroundColor: "#DBEAFE" }]}>
                                <Ionicons name="logo-paypal" size={22} color="#003087" />
                            </View>
                            <View>
                                <Text style={styles.payOptionTitle}>PayPal</Text>
                                <Text style={styles.payOptionSub}>Fast &amp; secure PayPal checkout</Text>
                            </View>
                        </View>
...
const getStyles = (isDark: boolean) => StyleSheet.create({
    ...
    sectionTitle: { fontSize: 15, fontWeight: "700", color: isDark ? "#F9FAFB" : "#111827", marginBottom: 14 },
    ...
    addressCardSelected: { borderColor: "#2D6A4F", backgroundColor: "#F0FDF4" },
    addressCardLeft: { flexDirection: "row", alignItems: "flex-start", gap: 12, flex: 1 },
    addressLabel: { fontSize: 11, fontWeight: "700", color: isDark ? "#9CA3AF" : "#6B7280", letterSpacing: 0.5 },
    addressStreet: { fontSize: 14, fontWeight: "600", color: isDark ? "#F9FAFB" : "#111827", marginTop: 2 },
    addressCity: { fontSize: 13, color: isDark ? "#9CA3AF" : "#6B7280" },
    defaultTag: { backgroundColor: "#D1FAE5", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
    ...
    itemThumbPlaceholder: { backgroundColor: isDark ? "#111827" : "#f3f4f6", alignItems: "center", justifyContent: "center" },
    itemName: { flex: 1, fontSize: 14, color: isDark ? "#D1D5DB" : "#374151", fontWeight: "500" },
    itemQty: { fontSize: 13, color: isDark ? "#9CA3AF" : "#6B7280", marginRight: 4 },
    itemPrice: { fontSize: 14, fontWeight: "700", color: isDark ? "#F9FAFB" : "#111827", minWidth: 60, textAlign: "right" },
    ...
    payOptionSelected: { borderColor: "#2D6A4F", backgroundColor: "#F0FDF4" },
    payOptionLeft: { flexDirection: "row", alignItems: "center", gap: 12 },
    payIconBg: { width: 44, height: 44, borderRadius: 12, alignItems: "center", justifyContent: "center" },
    payOptionTitle: { fontSize: 15, fontWeight: "600", color: isDark ? "#F9FAFB" : "#111827" },
    payOptionSub: { fontSize: 12, color: isDark ? "#9CA3AF" : "#6B7280", marginTop: 2 },

    // Card inputs
    cardInputs: { marginTop: 4, marginBottom: 4 },
    inputLabel: { fontSize: 12, fontWeight: "600", color: isDark ? "#9CA3AF" : "#6B7280", marginBottom: 6, marginTop: 10 },
    input: {
        borderWidth: 1.5,
        borderColor: isDark ? "#374151" : "#E5E7EB",
        borderRadius: 10,
    ...
    secureNote: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 10 },
    ...
    paypalNoteText: { fontSize: 13, color: "#1D4ED8", flex: 1, lineHeight: 18 },

    // Footer
    footer: { padding: 16, backgroundColor: isDark ? "#1F2937" : "#fff", borderTopWidth: 1, borderTopColor: "#F3F4F6" },
